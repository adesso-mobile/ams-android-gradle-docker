...
apt-get --quiet install --yes libxcursor1 libasound2 libxcomposite1 libnss3 libgl1 libpulse0 libnss3-dev pulseaudio libxcomposite1 libxcursor1 libpulse-dev --no-install-recommends
